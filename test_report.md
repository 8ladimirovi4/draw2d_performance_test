...
**Цель:** зафиксировать **рост объёма кучи** в Chrome после ключевых шагов сценария: первичная отрисовка схемы, **10 кликов** по интерактивному выключателю, **три** последовательных сдвига всего выделения на **~100 px** на холсте (ориентир — шкала в `client/js/perf-drag-distance-guide.js`, см. **AC_04** в требованиях).
